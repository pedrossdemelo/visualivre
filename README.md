...
Hate how MercadoLibre's desktop website only shows **one (??!!)** listing horizontally? Me too! VisuaLivre solves this annoyance with a responsive listing grid, filling even ultrawide screens!
...
I also made sure that **all useful filters are included** like price ranges, shipping costs and item condition. It has some cool added features like infinite scrolling and query caching, so coming back to your previous queries is instantaneous.
